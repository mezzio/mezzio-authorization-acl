...
- [#2](https://github.com/mezzio/mezzio-authorization-acl/pull/2) adds support for PHP 7.4.
...
- [#1](https://github.com/mezzio/mezzio-authorization-acl/pull/1) fixes ACL authorization adapter to grant access on request with failed routing.
